def apply_migration_forwards_lambdai(project_state: 'ProjectState', schema_editor: 'DatabaseSchemaEditor', operation: 'CreateModel', app_label: str, atomic: bool, atomic_obj: 'Callable'):
    """
